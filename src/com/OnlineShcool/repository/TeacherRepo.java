    ...
    public void addTeacher(Teacher teacher) {
        for (int i = 0; i < teacherArray.length; i++) {
            if (teacherArray[i] == null) {
                ...
                System.out.println("|---------------------------------------------------|");
                new Teacher(teacher.getTeacherName(), teacher.getTeacher_ID());
                teacher.setTeacherName(scannerTeacherRepo.next());
                System.out.println("|---------------------------------------------------|");
                System.out.println("|             Enter the ID of the Teacher           |");
                System.out.println("|---------------------------------------------------|");
                teacher.setTeacher_ID(scannerTeacherRepo.nextInt());
                teacherArray[i] = teacher;
                System.out.println("|---------------------------------------------------|");
                System.out.println(" Teacher Name — " + teacherArray[i].getTeacherName());
                System.out.println(" Teacher ID   — " + teacherArray[i].getTeacher_ID());
                System.out.println("|---------------------------------------------------|");
                while ( i == CAPACITY - 1) {
                ...
                System.out.println("~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
                System.out.println(" teacherArray — " + Arrays.toString(getTeacherArray()));
            }
        }
    }
